...
import { readCalendarEvents, createCalendarEvent, deleteCalendarEvent, } from "./calendar.js";
import { readContacts, searchContacts, createContact, } from "./contacts.js";
...
class PowerShellService {
    ...
    simulateScriptRun(scriptName, args) {
        ...
        return [
            ...
            tool({
                ...
                execute: async ({ profileName }) => {
                    ...
                    const result = await powershellService.runRawCommand(`New-ItemProperty -Path "HKCU:\\Software\\Microsoft\\Office\\16.0\\Outlook\\Profiles\\${profileName}" -Name "DefaultProfile" -Value 1 -Force`);
                    return {
                        success: result.success,
